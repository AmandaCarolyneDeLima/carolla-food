...
<body>
  ...
  <header>
    ...
    <form action="<?= URL_RAIZ . 'receitas/filtrar'?>" method="post">
        <input type="text" name="filtro" placeholder="Filtre por ingrediente" value="<?= ($this->getPost('filtro') != null) ? $this->getPost('filtro') : '' ?>">
        ...
        <input class="submit" type="submit" value="Filtrar">
            ...
            <li class="nav-item"> <a class="nav-link" href="<?= URL_RAIZ . 'receitas/criar'?>">Cadastrar receitas</a> </li>
             ...
             <li class="nav-item"> <a class="nav-link" href="<?= URL_RAIZ . 'login'?>">Entrar</a> </li>
